...
import image1 from '../images/Photo by Amin RK.png';
import image2 from '../images/person1.jpg';
import image3 from '../images/Photo by Chris Zhang (1).png';
import image4 from '../images/person2.jpg';
import image5 from '../images/Photo by Franco Figueroa.png';
import image6 from '../images/Photo by Hayes Potter.png';
import image7 from '../images/Photo by Joe Gardner (1).png';
import image8 from '../images/person3.jpg';
import image9 from '../images/Photo by Matteo Minoglio (1).png';
import image10 from '../images/person4.jpg';
import image11 from '../images/Photo by Peter Idowu (1).png';
import image12 from '../images/person1.jpg';
    ...
    <div className="profile-view">
      {creators.map(creator => (
        <div key={creator.id} className="profile-card">
          ...
          <button onClick={() => handleEdit(creator)} className="edit-button">
            Edit
          </button>
        </div>
      ))}
